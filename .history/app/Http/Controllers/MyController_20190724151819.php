...
//User
    ...
    public function postthemuser(Request $request){
     ...
     public function postsuauser(Request $request,$id){
         ...
         return view('admin/user/sua/'.$id)->with('thongbao','Sửa User thành công');
     }
...
//Tin Tức
    public function danhsachtintuc(){$tintuc=tintuc::all();
        ...
        public function postthemtintuc(Request $request){
            ...
            $loaitin=loaitin::all();
            return view('admin/tintuc/them',['loaitin'=>$loaitin])->with('thongbao','Bạn đã thêm tin tức thành công.');
        }
        ...
        public function getxoatintuc($id){
            ...
            return redirect('admin/tintuc/danhsach',['tintuc'=>$tintuc])->with('thongbao','Bạn đã xóa Tin tức thành công.');
        }
