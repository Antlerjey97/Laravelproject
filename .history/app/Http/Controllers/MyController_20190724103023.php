...
//Tin Tức
    public function danhsachtintuc(){$tintuc=tintuc::all();
        ...
        public function postthemtintuc(Request $request){
            ...
            $tintuc1->Hinh=$request->hinh;
            $tintuc1->idLoaiTin=$request['idloaitin'];
            $tintuc1->NoiBat=$request['noibat'];

            $tintuc->save();
            }
            return view('admin/tintuc/them')->with('thanhcong','Bạn đã thêm tin tức thành công.');
        }
