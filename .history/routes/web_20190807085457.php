...
//User Controller 
Route::get('pages','PageController@trangchu')->middleware('role:editor');
Route::get('lienhe','PageController@lienhe')->middleware('role:editor');

Route::get('loaitin','PageController@loaitin')->middleware('role:editor');
//Route::get('tintuc/{$id}','PageController@tintuc');

Route::get('tintuc/{id}','PageController@tintuc')->middleware('role:editor');
Route::get('news/{id}','PageController@news')->middleware('role:editor');
...
Route::get('thongtin','PageController@getthongtin')->middleware('role:editor');
Route::post('thongtin','PageController@postthongtin')->middleware('role:editor');