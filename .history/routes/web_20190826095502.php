...
//User Controller 
Route::get('pages','PageController@trangchu')->middleware('login');
Route::get('lienhe','PageController@lienhe')->middleware('login');

Route::get('loaitin','PageController@loaitin')->middleware('login');
//Route::get('tintuc/{$id}','PageController@tintuc');

Route::get('tintuc/{id}','PageController@tintuc')->middleware('login');
Route::get('news/{id}','PageController@news')->middleware('login');
...
Route::get('thongtin','PageController@getthongtin')->middleware('login');
Route::post('thongtin','PageController@postthongtin')->middleware('login');
